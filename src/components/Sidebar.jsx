...
import { Home, FolderOpen, Settings, MessageCircle, Download, Menu, X } from 'lucide-react';
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 w-10 h-10 bg-gray-900 text-white rounded-md flex items-center justify-center border border-gray-700 hover:bg-gray-800 transition-colors"
      >
      ...
      {/* Sidebar */}
      <div className={`
        w-64 bg-black text-white h-screen fixed left-0 top-0 flex flex-col z-50 border-r border-gray-800
        transform transition-transform duration-300 ease-in-out
        ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}
        lg:translate-x-0
      `}>
        {/* Profile Section */}
        <div className="p-6 pb-8 pt-16 lg:pt-6">
