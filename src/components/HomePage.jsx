  ...
  return (
    <div className="relative">
      ...
      <div className="py-20 relative z-10">
        <h2 className="text-5xl font-bold text-white mb-16 tracking-tight">Bio</h2>
        ...
        <div className="grid md:grid-cols-2 gap-16 mb-20">
          ...
          <div className="flex justify-center md:justify-end">
            <div className="w-80 h-80 bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl flex items-center justify-center border border-gray-700">
        ...
        {/* Publications */}
        <div className="mb-20">
          <h3 className="text-3xl font-bold text-white mb-12">Publications & Research</h3>
        ...
        <div className="mb-20">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-blue-600/10 to-purple-600/10 backdrop-blur-sm rounded-2xl p-8 border border-blue-500/30 hover:border-blue-400 transition-all duration-200 group cursor-pointer">
              <div className="flex items-center justify-between">
                ...
                <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Code className="text-white" size={28} />
                </div>
              </div>
            </div>
        ...
        <div className="mb-32">
          <h3 className="text-3xl font-bold text-white mb-12">Leadership & Achievements</h3>
      ...
      <div className="py-20 text-center relative overflow-hidden">
        <div className="relative">
          <h2 className="text-[12rem] md:text-[16rem] lg:text-[12rem] font-black text-transparent bg-clip-text bg-gradient-to-b from-gray-200/70 to-transparent tracking-[0.2em] select-none uppercase leading-none">
            RISHABH
          </h2>
